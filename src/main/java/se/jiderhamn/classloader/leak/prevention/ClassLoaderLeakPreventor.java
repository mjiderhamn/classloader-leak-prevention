...
//    }
  ...
  private class JettyJMXRemover {
    ...
    public JettyJMXRemover(ClassLoader classLoader) throws Exception {
      ...
      final Object webappContext = getClassFromWebApplicationParentClassLoader("org.eclipse.jetty.webapp.WebAppClassLoader")
              .getMethod("getContext").invoke(classLoader);
      if(webappContext == null)
        return;
      
      // Server server = (Server)webappContext.getServer();
      final Class<?> webAppContextClass = getClassFromWebApplicationParentClassLoader("org.eclipse.jetty.webapp.WebAppContext");
      ...
      final Class<?> mBeanContainerClass = getClassFromWebApplicationParentClassLoader("org.eclipse.jetty.jmx.MBeanContainer");
      beanContainer = getClassFromWebApplicationParentClassLoader("org.eclipse.jetty.server.Server")
      ...
      if (beanContainer != null) {
        ...
        if(sessionHandler != null) {
          ...
          final Object sessionManager = getClassFromWebApplicationParentClassLoader("org.eclipse.jetty.server.session.SessionHandler")
          ...
          if(sessionManager != null) {
            ...
            final Object sessionIdManager = getClassFromWebApplicationParentClassLoader("org.eclipse.jetty.server.SessionManager")
        ...
        if(servletHandler != null) {
          ...
          final Class<?> servletHandlerClass = getClassFromWebApplicationParentClassLoader("org.eclipse.jetty.servlet.ServletHandler");
    ...
    Class getClassFromWebApplicationParentClassLoader(String className) throws ClassNotFoundException {
